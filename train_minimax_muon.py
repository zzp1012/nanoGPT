...
from utils.model_minimax import build_minimax_model
from utils.muon import get_optimizer
...
wandb_project = 'minimax_finewebedu_muon'
wandb_run_name = '170M_muon_constant_100tpp' # 'run' + str(time.time())
# data
dataset = 'finewebedu'
...
weight_decay = 0.1 # default for AdamW and Muon
momentum = 0.95 # default for Muon
